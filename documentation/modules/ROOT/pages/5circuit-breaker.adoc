...
[source,bash,subs="+macros,+attributes"]
----
./scripts/clean.sh tutorial-$WORKSHOP_USER
----
...
NOTE: The previous command will do a rolling deployment of `recommendation-v2`, you can watch the status using the command `oc get pods -w`
...
[source,bash,subs="+macros,+attributes"]
----
oc create -f link:{github-repo}/{istiofiles-dir}/virtual-service-recommendation-timeout.yml[istiofiles/virtual-service-recommendation-timeout.yml] -n tutorial{namespace-suffix}
----
...
[source,bash,subs="+macros,+attributes"]
----
oc delete -f istiofiles/virtual-service-recommendation-timeout.yml -n tutorial{namespace-suffix}
----
...
Let's perform a load test in our system with https://github.com/rakyll/hey[`hey`]. We'll have 10 clients sending 4 concurrent requests each:

[source,bash,subs="+macros,+attributes"]
----
hey -n 40 -c 4 http://istio-ingressgateway-istio-system.{appdomain}/{path}
----

You should see an output similar to this:

image:timeout_hey_200.png[hey output with all successful requests]
...
[source,bash,subs="+macros,+attributes"]
----
oc create -f link:{github-repo}/{istiofiles-dir}/destination-rule-recommendation-v1-v2.yml[istiofiles/destination-rule-recommendation-v1-v2.yml] -n tutorial{namespace-suffix}
oc create -f link:{github-repo}/{istiofiles-dir}/virtual-service-recommendation-v2.yml[istiofiles/virtual-service-recommendation-v2.yml] -n tutorial{namespace-suffix}
----
...
[source,bash,subs="+macros,+attributes"]
----
oc replace -f link:{github-repo}/{istiofiles-dir}/destination-rule-recommendation_cb_policy_version_v2.yml[istiofiles/destination-rule-recommendation_cb_policy_version_v2.yml] -n tutorial{namespace-suffix}
----

[source,bash,subs="+macros,+attributes"]
----
hey -n 40 -c 4 -v http://istio-ingressgateway-istio-system.{appdomain}/{path}
----
...
[source,bash,subs="+macros,+attributes"]
----
oc delete -f link:{github-repo}/{istiofiles-dir}/destination-rule-recommendation_cb_policy_version_v2.yml[istiofiles/destination-rule-recommendation_cb_policy_version_v2.yml] -n tutorial{namespace-suffix}

oc delete -f link:{github-repo}/{istiofiles-dir}/virtual-service-recommendation-v2.yml[istiofiles/virtual-service-recommendation-v2.yml] -n tutorial{namespace-suffix}
----
