...
:doc-sec: advrr-recommendation-allv1
:k8s-cmd-opt: create
...
:doc-sec: advrr-recommendation-v2-safari
:k8s-cmd-opt: replace
:istio-file: virtual-service-safari-recommendation-v2.yml
include::ROOT:partial$command-snippets.adoc[tag=istio-rules]
...
----
copyToClipboard::advrr-oc-get-vs[]
ifndef::workshop[]
====
endif::[]
...
Open the url http://customer-tutorial{namespace-suffix}.{appdomain} in your browser.
...
----
copyToClipboard::advrr-curl-to-v2[]
...
----
copyToClipboard::advrr-curl-to-v1[]
...
----
copyToClipboard::advrr-oc-desc-vs[]
ifndef::workshop[]
====
endif::[]
...
:doc-sec: advrr-remove-safari-rule
:k8s-cmd-opt: delete
:istio-file: virtual-service-safari-recommendation-v2.yml
include::ROOT:partial$command-snippets.adoc[tag=istio-rules]
...
:doc-sec: advrr-all-to-v2
:k8s-cmd-opt: create
:istio-file: virtual-service-mobile-recommendation-v2.yml
include::ROOT:partial$command-snippets.adoc[tag=istio-rules]
...
----
copyToClipboard::advrr-curl-mobile[]

==== Clean up

Delete Destination Rule:

:doc-sec: advrr-cleanup
:k8s-cmd-opt: delete
:istio-file: destination-rule-recommendation-v1-v2.yml
include::ROOT:partial$command-snippets.adoc[tag=istio-rules]
...
:doc-sec: advmir-start
include::ROOT:partial$cleanup-rules.adoc[]

Make sure you are in the main directory of "istio-tutorial" i.e. pass:[$TUTORIAL_HOME]
...
:doc-sec: advmir
:k8s-cmd-opt: create
:istio-file: virtual-service-recommendation-v1-mirror-v2.yml
include::ROOT:partial$command-snippets.adoc[tag=istio-rules]
...
[source,bash,subs="+macros,+attributes"]
----
kubectl logs -n tutorial{namespace-suffix} -f \
`kubectl get pods -n tutorial{namespace-suffix}|grep recommendation-v2|awk '{ print $1 }'` \
-c recommendation
----
oc::
+
...
[source,bash,subs="+macros,+attributes"]
----
oc logs -n tutorial{namespace-suffix} -f \
`oc get pods -n tutorial{namespace-suffix}|grep recommendation-v2|awk '{ print $1 }'` \
-c recommendation
----
ifndef::workshop[]
====
...
----
copyToClipboard::advmir-cleanup[]
...
:doc-sec: advlb-scale-2
:deployment: recommendation-v2
:replicas: 2
include::ROOT:partial$command-snippets.adoc[tag=scale-deployment]

Wait a bit `kubectl get pods -w` or `oc get pods -w` to watch and curl the customer endpoint many times
...
curl customer-tutorial{namespace-suffix}.{appdomain}
----
copyToClipboard::advlb-run-req[]

Add a 3rd v2 pod to the mix

:doc-sec: advlb-scale-3
:deployment: recommendation-v2
:replicas: 3
include::ROOT:partial$command-snippets.adoc[tag=scale-deployment]
...
----
copyToClipboard::advlb-run-many-req[]
...
:doc-sec: advlb
:k8s-cmd-opt: create
:istio-file: destination-rule-recommendation_lb_policy_app.yml
include::ROOT:partial$command-snippets.adoc[tag=istio-rules]
