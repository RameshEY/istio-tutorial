...
----
ifdef::workshop[]
open https://grafana-istio-system.{appdomain}/d/TSEY6jLmk/istio-galley-dashboard?orgId=1
or
firefox https://grafana-istio-system.{appdomain}/d/TSEY6jLmk/istio-galley-dashboard?orgId=1
endif::workshop[]
...
----
ifdef::workshop[]
https://grafana-istio-system.{appdomain}/d/UbsSZTDik/istio-workload-dashboard?refresh=5s&orgId=1"
endif::workshop[]
...
----
ifdef::workshop[]
open https://prometheus-istio-system.{appdomain}/graph?g0.range_input=1m&g0.stacked=1&g0.expr=&g0.tab=0"
or
firefox https://prometheus-istio-system.{appdomain}/graph?g0.range_input=1m&g0.stacked=1&g0.expr=&g0.tab=0"
endif::workshop[]
...
----
ifdef::workshop[]
open https://jaeger-istio-system.{appdomain}/
or
firefox https://jaeger-istio-system.{appdomain}/
endif::workshop[]
