...
[source,bash,subs="attributes+,+macros"]
----
oc -n tutorial{namespace-suffix} get virtualservice 
----
copyToClipboard::srr-oc-get-vsvc[]

[#srr-oc-get-vsvc-yaml]
[source,bash,subs="attributes+,+macros"]
----
oc -n tutorial{namespace-suffix} get virtualservice -o yaml 
----
copyToClipboard::srr-oc-get-vsvc-yaml[]
ifndef::workshop[]
--
====
endif::[]
